...
src = pathlib.Path("/home/claude/wetheusers/docs/essay/the-longer-race.md").read_text()
parts = re.split(r'\n-{3,}\n', src, maxsplit=1)
...
blockquote { margin: 1.4em auto; max-width: 150mm; font-size: 13.5pt; line-height: 1.5; font-style: italic; color: #1b2a4a; text-align: center; border-top: 2px solid #d8c79a; border-bottom: 2px solid #d8c79a; padding: 0.7em 0.6em; }
blockquote p { margin: 0; }
blockquote em { font-style: normal; font-weight: 700; }
...
<section class="docheader">
  ...
  <div class="title">The Longer Race</div>
  <div class="drule"></div>
  <div class="subtitle">Why the race worth running is the next thousand years, not the next quarter &mdash; run together, not sprinted alone</div>
...
html = TEMPLATE.replace("__CSS__", CSS).replace("__BODY__", html_body).replace("__META__", dm.meta_html("the-longer-race"))
pathlib.Path("/home/claude/coop.html").write_text(html)
