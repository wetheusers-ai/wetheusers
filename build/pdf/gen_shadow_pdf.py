...
src = pathlib.Path("/home/claude/wetheusers/docs/essay/shape-of-your-digital-shadow.md").read_text()
parts = re.split(r'\n-{3,}\n', src, maxsplit=1)
...
.docheader .title {
  font-size: 38pt; line-height: 1.06; margin: 0 auto; color: #1b2a4a;
...
<section class="docheader">
  ...
  <div class="title">Your Digital Shadow</div>
  <div class="drule"></div>
  <div class="subtitle">What your data is made of &mdash; and who should be able to see it, change it, and profit from it</div>
...
html = TEMPLATE.replace("__CSS__", CSS).replace("__BODY__", html_body).replace("__META__", dm.meta_html("shape-of-digital-shadow"))
pathlib.Path("/home/claude/shadow.html").write_text(html)
print("Shadow essay HTML written:", len(html), "chars; has table:", "<table>" in html)
