...
# Give the footnote block a heading in the house voice.
...
<section class="docheader">
  ...
  <div class="title">The Ledger and the Spoils</div>
  <div class="drule"></div>
  <div class="subtitle">Crypto decentralized the ledger, not the spoils. Why an internet owned by its users must decentralize the rewards &mdash; and how AI and crypto together finally can.</div>
